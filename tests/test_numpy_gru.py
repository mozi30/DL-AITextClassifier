...
from src.text_embedding import WordEmbedding, NgramEmbedding
from src.dataloader import SentenceDataModule
from src.models.gru_numpy import DenseLayer, BiGRULayer, MultiHeadAttentionLayer, EmbeddingLayer, SequenceMeanMaxPool, DropoutLayer, NeuralNetwork, CrossEntropyLoss, SoftmaxActivation, accuracy 

if __name__ == '__main__':
    seed = 42
    record_path = str(ROOT / "datasets" / "records_long.json")
    weights_path = str(ROOT / "cache" / "numpy_gru_weights.pkl")
    ...
    # To resume from saved layer weights in a future run:
